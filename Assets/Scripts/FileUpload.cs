...
public class FileUpload : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		if (GUI.Button(new Rect(200,250,120,100),"Save, Play & Upload"))
		{
		...
		if (GUI.Button(new Rect(400,100,120,100),"Set position 1"))
		{ 
			myLat = 5f;
			myLong = 5f;
			Debug.Log ("My position: " + myLat.ToString() + "," + myLong.ToString() );
		}
		if (GUI.Button(new Rect(400,250,120,100),"Set position 2"))
		{
			myLat = 50f;
			myLong = 50f;
			Debug.Log ("My position: " + myLat.ToString() + "," + myLong.ToString() );
